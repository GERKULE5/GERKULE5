...
🇷🇺 Based in Russia | more than 1 year of commercial experience
...
- 🔭 **Working on:** Backend development with Python and Node.js
- 🌱 **Learning:** Go (Golang) - planning to fully transition to it
- 👯 **Looking to collaborate on:** Interesting backend projects, especially in Go
- 🤝 **Open to:** Job opportunities and internships in backend development or analytics

## 💬 Ask me about

- Building REST APIs with FastAPI and NestJS
- Working with SQL databases and Redis
- Message queuing with Kafka
- Transitioning from Python/Node.js to Go

## 📫 Connect with me

- Email: [konstantinkochengin44@gmail.com]
